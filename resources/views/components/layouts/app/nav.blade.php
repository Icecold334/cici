<div class="lg:ml-64">
  <nav
    class="fixed top-0 left-0 right-0 z-30 bg-gradient-to-br h-14 from-primary-600 via-primary-600 to-primary-700  px-4 py-3 flex justify-between items-center lg:left-64">
